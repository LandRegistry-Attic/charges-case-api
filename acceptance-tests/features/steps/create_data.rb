...
Given(/^I have created a case$/) do
  ...
  @created_case = get_case_data(@created_case_id)
end

Given(/^I have created a case with a property but no borrowers$/) do
  @created_case_id = create_case_data
...
Given(/^I have created a case with one borrower$/) do
  @created_case_id = create_case_data
...
Given(/^I have created a case with two borrowers$/) do
  @created_case_id = create_case_data
